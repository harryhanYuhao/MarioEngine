...
public class Shader {
    ...
    public void compile_link(){
        ...
        int success = glGetShaderi(vertexID, GL_COMPILE_STATUS); // Getshaderi= get shader info
        if (success == GL_FALSE){
        ...
        // Check for errors in compilation
        success = glGetShaderi(fragmentID, GL_COMPILE_STATUS); // Getshaderi= get shader info
        if (success == GL_FALSE){
    ...
    public void uploadMat4f(String varName, Matrix4f mat4){
        ...
        mat4.get(matBuffer); // Get the matrix data and put it in the 1D buffer [1, 1, ...]
    ...
    public void uploadMat3f(String varName, Matrix3f mat3){
        ...
        mat3.get(matBuffer); // Get the matrix data and put it in the 1D buffer [1, 1, ...]
    ...
    public void uploadVec3f(String varName, Vector4f vec3f){
        int varLocation = glGetUniformLocation(shaderProgramID, varName);
        use();
